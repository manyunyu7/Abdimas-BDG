        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img height="50px" src="{{ URL::to('bootstrap_ui') }}/assets/images/albinaa.png" alt="homepage"
                            class="dark-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img  height="35px" src="{{ URL::to('bootstrap_ui') }}/assets/images/albinaa_long.png" alt="homepage"
                            class="dark-logo" />
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                class="text-dark">{{ Auth::guard('erte')->user()->kode . "-" . Auth::guard('erte')->user()->rw_detail->kode }}</span> <i
