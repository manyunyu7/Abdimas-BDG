...
@section('page-wrapper')
    ...
    <div class="card border-success">
        <div class="card-header bg-success">
            <h4 class="mb-0 text-white">Ajukan Surat Pengantar Baru</h4>
        </div>
        <div class="card-body">
            <form action="{{ url('surat/store') }}" method="post">
                ...
                <div class="form-group">
                    <label for="">Pilih Anggota Keluarga Yang Akan Dibuatkan Surat Pengantar : </label>
                ...
                <button type="submit" class="btn btn-block btn-primary">Kirim Permintaan Pembuatan Surat</button>
            </form>
