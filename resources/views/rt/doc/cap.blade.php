...
@section('page-wrapper')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white rounded-top">
                <h4 class="mb-0 "> Upload Stempel Baru</h4>
            </div>
            <div class="card-body">
                <form action="{{ url('rt/new-cap') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_rt" value="{{ $rt->id }}">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white rounded-top">
                <h4 class="mb-0 ">Ketentuan Stempel (PENTING)</h4>
            </div>

            <div class="mt-4">
                <ol>
                    <li>
                        Stempel yang akan digunakan pada surat warga adalah stempel dengan tanggal terbaru
                    </li>

                    <li>Tanda Tangan harus <strong>tidak memiliki background warna apapun (transparan) </strong>seperti pada gambar dibawah <br>
                        <img style="border-radius:10px !important" class=""
                            src="{{ url('/') }}/static_img/example_cap.png" alt=""
                            onerror="this.onerror=null;this.src='{{ url('/') }}img/onerror.png';">

                    </li>

                    <li>
                        Untuk Pengarsipan Surat, Stempel yang sudah diinput tidak dapat dihapus, pastikan mengupload stempel yang sesuai
                    </li>
                    <li>
                        Untuk membuat stemepl dengan background transparan, anda dapat menggunakan situs 
                        <a href="https://mystampready.com/en/constructor/">Ini</a>
                    </li>
