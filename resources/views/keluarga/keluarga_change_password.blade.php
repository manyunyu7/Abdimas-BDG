...
@section('page-breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Keluarga
                {{ $keluarga->nama }}</h3>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white rounded-top">
                <h4 class="mb-0 "> Ganti Password Keluarga</h4>
            </div>
            <div class="card-body">
                <form action="{{ url('keluarga/'.$keluarga->id.'/ganti-password') }}" method="post">
                    @csrf
