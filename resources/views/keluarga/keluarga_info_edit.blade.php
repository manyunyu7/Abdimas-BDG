...
@section('page-wrapper')
    ...
    <section id="photoKK">
        ...
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/keluarga' . '/' . $keluarga->id . '/changeKKPhoto') }}" method="post"
        ...
        <div class="card-body">
            <form action="{{ url('/keluarga/updateData') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama" id="" value="{{ $keluarga->nama }}"
                        placeholder="Nama Keluarga">
                    <small class="form-text text-muted">Nama Kelurga</small>
                </div>
                <div class="form-group">
                    <label for="">Nomor KK</label>
                    <input type="text" class="form-control" required name="no_kk" id="" value="{{ $keluarga->no_kk }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required name="kontak" id="" value="{{ $keluarga->kontak }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="rt" id="">
                        <option value="{{ $keluarga->rt_detail->id }}">{{ $keluarga->rt_detail->join_info }}</option>
                        @foreach ($rt as $item)
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="alamat" id="" rows="5">{{ $keluarga->alamat }}</textarea>
                </div>
    ...
    <section id="photoKK">
        ...
        <div class="card ">
            ...
            <div class="card-body">
                <a target="_blank" class="mb-5" href="{{ url('keluarga' . '/' . $keluarga->id . '/anggota/tambah') }}">
                    <button type="button" class="btn btn-outline-primary">Tambah Anggota Keluarga</button>
                </a>
